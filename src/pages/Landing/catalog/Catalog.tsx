...
export default function Catalog() {
    ...
    const applyFilters = (carList: SB_CarForRentModel[]) => {
        ...
        if (filters.pick_up_location) {
            filteredCars = filteredCars.filter((car) => 
                car.pick_up_location.toLowerCase().includes(filters.pick_up_location.toLowerCase()))
        };
        return filteredCars;
    }

    const filteredCars = applyFilters(cars.cars);
    ...
    useEffect(() => {
        if (filters.pick_up_location || filters.date_collection) {
