...
export const carSchema = z.object({
  group: z
    .enum(["Económico", "SUV Compacto", "Sedán Premium"])
  ...
  fuel_type: z
    .enum(["gasolina", "diésel", "híbrido", "eléctrico"])
    .refine((val) => val !== undefined, {
  ...
  rental_duraction_days: z
    .number()
    .min(1, "La duración mínima debe ser al menos 1 día")
    .optional(),
  pick_up_location: z
    .string()
    .min(5, "La ubicación es muy corta")
    .max(200, "Ubicación demasiado larga"),

  travel_conditions: z
    .string()
    .min(10, "Describe las condiciones de viaje (mínimo 10 caracteres)")
