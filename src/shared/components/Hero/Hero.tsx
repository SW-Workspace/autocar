            ...
            <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
                <div className="flex flex-col justify-center space-y-6 animate-fade-in-up">
                    ...
                    <div className="inline-flex items-center gap-3 rounded-lg bg-[#F37513] px-4 py-3 animate-scale-in">
                        <div className="text-2xl font-bold text-accent-foreground">15% OFF</div>
                        <div className="text-sm text-accent-foreground">
                            <div className="font-semibold">Usa el cupón BIENVENIDO</div>
                            <div className="text-xs opacity-90">Válido hasta el 31 de diciembre de 2025</div>
                        </div>
                    </div>
                        ...
                        <div className="space-y-4">
                            <div className="grid gap-4 md:grid-cols-2">
                                <div className="space-y-2">
                                    <label htmlFor="city" className="text-sm font-medium text-card-foreground">Lugar de recogida</label>
                                ...
                                <div className="space-y-2">
                                    <label htmlFor="date-collection" className="text-sm font-medium text-card-foreground">Fecha de recogida</label>
                                    <div className="relative">
                                        <svg 
                                            xmlns="http://www.w3.org/2000/svg" 
                                            width="24" 
                                        ...
                                        <input type="date" name="date-collection" id="date-collection" className="file:text-foreground placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground dark:bg-input/30 border-input h-9 w-full min-w-0 rounded-md border bg-transparent px-3 py-1 text-base shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive pl-10" />
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    <label htmlFor="time" className="text-sm font-medium text-card-foreground">Hora</label>
                                    <div className="relative">
                                        <svg 
                                            xmlns="http://www.w3.org/2000/svg" 
                                            width="24" 
                                        ...
                                        <input type="time" name="time" id="time" className="file:text-foreground placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground dark:bg-input/30 border-input h-9 w-full min-w-0 rounded-md border bg-transparent px-3 py-1 text-base shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive pl-10" />                                        
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    <label htmlFor="date-return" className="text-sm font-medium text-card-foreground">Fecha de devolución</label>
                                    <div className="relative">
                                        <svg 
                                            xmlns="http://www.w3.org/2000/svg" 
                                            width="24" 
                                        ...
                                        >
                                            ...
                                            <input type="date" name="date-return" id="date-return" className="file:text-foreground placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground dark:bg-input/30 border-input h-9 w-full min-w-0 rounded-md border bg-transparent px-3 py-1 text-base shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive pl-10" />
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="relative hidden lg:block animate-fade-in-up">
                        <div className="relative h-full min-h-[500px] rounded-2xl overflow-hidden">
                            <img src="https://v0-car-rental-page-seven.vercel.app/happy-person-driving-modern-car.jpg" alt="Foto como ejemplo" />
