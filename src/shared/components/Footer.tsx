            ...
            <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-4 gap-10">
                <div>
                    ...
                    <p className="text-sm mb-4">
                        Tu mejor opción para alquilar vehículos de calidad con el mejor servicio.
                    </p>
                ...
                <div>
                    ...
                    <ul className="space-y-2 text-sm">
                        <li><a href="#" className="hover:underline">Corporativo</a></li>
                        <li><a href="#" className="hover:underline">Socios</a></li>
                        <li><a href="#" className="hover:underline">Franquicias</a></li>
                    </ul>
                </div>
